...
import com.tekcapzule.newsdigest.application.function.input.DisableInput;
import com.tekcapzule.newsdigest.application.mapper.InputOutputMapper;
import com.tekcapzule.newsdigest.domain.command.DisableCommand;
...
public class DisableFunction implements Function<Message<DisableInput>, Message<Void>> {
    ...
    public DisableFunction(final NewsDigestService newsDigestService, final AppConfig appConfig) {
