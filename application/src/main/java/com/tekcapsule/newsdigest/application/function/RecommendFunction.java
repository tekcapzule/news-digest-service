...
import com.tekcapsule.newsdigest.application.function.input.RecommendInput;
import com.tekcapsule.newsdigest.application.mapper.InputOutputMapper;
import com.tekcapsule.newsdigest.domain.command.RecommendCommand;
...
public class RecommendFunction implements Function<Message<RecommendInput>, Message<Void>> {
    ...
    public RecommendFunction(final NewsDigestService newsDigestService, final AppConfig appConfig) {
    ...
    public Message<Void> apply(Message<RecommendInput> recommendInputMessage) {
        ...
        try {
            ...
            log.info(String.format("Entering recommend newsdigest Function -  NewsDigest code:%s", recommendInput.getCode()));
            ...
            newsDigestService.recommend(recommendCommand);
